-- Add gemini_prompt column to instagram_settings
ALTER TABLE "instagram_settings"
  ADD COLUMN IF NOT EXISTS "gemini_prompt" text;

-- Populate with default prompt from gemini-prompt.md
UPDATE "instagram_settings"
SET "gemini_prompt" = '# AI Prompt for Event Poster Data Extraction
...
WHERE "gemini_prompt" IS NULL OR "gemini_prompt" = '';
